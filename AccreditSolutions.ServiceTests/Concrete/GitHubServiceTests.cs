...
namespace Service.Tests
{
    ...
    public class GitHubServiceTests
    {
        ...
        {      
            ...
            _mockEnvironmentVariables.Setup(x => x.GitHubUrl).Returns("https://api.github.com");
        ...
        [Test]
        public void RetrieveUser_ShouldThrowException_WhenJsonInvalid()
        {
            // Arrange
            var username = "nonexistentuser";
            var url = "https://api.github.com/users/nonexistentuser";
            ...
            // Assert
            Assert.Throws<Exception>(() => _gitHubService.RetrieveUser(username));
        }
        ...
        [Test]
        public void RetrieveUser_ShouldReturnGitHubUserWithoNoRepos_WhenUserFoundWithoutRepoUrl()
        {
            // Arrange
            var username = "validuser";
            var url = "https://api.github.com/users/validuser";
            var jsonResponse = "{\"login\":\"validuser\",\"location\":\"Location1\",\"avatar_url\":\"http://example.com/avatar\",\"repos_url\":\"\"}";
            ...
            Assert.That(result.GitHubRepositories, Has.Count.EqualTo(0));
        }

        [Test]
        public void RetrieveUser_ShouldReturnGitHubUserWithoNoRepos_WhenUserButHasNoRepos()
        {
            // Arrange
            var username = "validuser";
            var url = "https://api.github.com/users/validuser";
        ...
        public void RetrieveUser_ShouldReturnGitHubUser_WhenUserFound()
        {
            ...
            var userUrl = "https://api.github.com/users/validuser/repos";
            _mockWebClient.Setup(x => x.DownloadString(userUrl)).Returns("[{\"name\": \"Repo1\", \"stargazers_count\": 5}, {\"name\": \"Repo2\", \"stargazers_count\": 10}]");
            ...
            Assert.That(result.GitHubRepositories[0].RepositoryName, Is.EqualTo("Repo2"));
            Assert.That(result.GitHubRepositories[1].RepositoryName, Is.EqualTo("Repo1"));
        }

        [Test]
        public void RetrieveUser_ShouldReturnGitHubUserWithoutRepos_WhenReposUrlIsEmpty()
        {
            // Arrange
        ...
        [Test]
        public void GetRepositories_ShouldReturnNull_WhenJsonResultIsEmpty()
        {
            // Arrange
            ...
            // Act
            var result = _gitHubService.GetRepositories(url);
        ...
        [Test]
        public void GetRepositories_ShouldReturnListOfRepositories_WhenJsonResultIsValid()
        {
            // Arrange
            var url = "https://api.github.com/users/someuser/repos";
            ...
            Assert.That(result[0].RepositoryName, Is.EqualTo("Repo2"));
            Assert.That(result[1].RepositoryName, Is.EqualTo("Repo1"));
        }
    }
}
