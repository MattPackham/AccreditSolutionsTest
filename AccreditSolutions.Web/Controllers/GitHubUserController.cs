...
namespace AccreditSolutions.Controllers
{
    ...
    {
        private readonly IUsernameValidator _iUserNameValidator;
        private readonly IGitHubService _iGitHubService;
        ...
        public ActionResult RetrieveGitHubUser(RetrieveGitHubUserViewModel model)
        {
            try
            {
                ...
                var gitHubUser = _iGitHubService.RetrieveUserWithRepositories(model.Username);
